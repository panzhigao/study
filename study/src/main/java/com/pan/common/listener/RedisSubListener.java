...
/**
 * redis消息订阅监听器,当所有的Bean被成功装载后执行
 * @author panzhigao
 */
public class RedisSubListener implements ApplicationListener<ContextRefreshedEvent> {

	private static final Logger logger = LoggerFactory.getLogger(RedisSubListener.class);
